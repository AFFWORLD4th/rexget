    ...
    <Card className="relative overflow-hidden rounded-none shadow-sm bg-white p-0 border cursor-pointer" onClick={() => router.push(`/buy/details/${data.id}`)}>
      <div className="relative w-full h-80">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          <span className="bg-[#000000] text-white px-3 py-1 text-xs tracking-wider uppercase">
            For Sale
          </span>
      ...
      <CardContent className="grid gap-2 px-4 py-3">
        ...
        <p className="text-sm font-bold text-[#1A202C] tracking-wide">
          {data.price ? <PriceDisplay priceInAED={data.price} /> : "Price on request"}
        </p>
        ...
        <div className="flex items-end justify-between text-gray-600 text-sm mt-2 font-light">
          ...
          <div className="flex items-center justify-center">
            {data?.agent?.avatar ? (
              <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-[#000000] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
                <Image
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#000000] to-[#171717] flex items-center justify-center shadow-lg">
