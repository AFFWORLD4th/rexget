  ...
  const testimonials = [
    {
      ...
      review: "From listing to closing, Rexgate provided excellent service. They marketed my property effectively and brought in serious buyers within days.",
    ...
    },
    {
      ...
      review: "Rexgate's expertise helped me get the best value for my home. Their marketing efforts were amazing, and the sale process was seamless.",
      avatar: <User className="w-8 h-8" />
    },
    {
      name: "Mark H.",
      ...
      review: "The entire process was quick and efficient. The Rexgate team took care of everything from marketing to negotiating offers. I'm delighted with their work.",
      avatar: <User className="w-8 h-8" />
    }
  ];
