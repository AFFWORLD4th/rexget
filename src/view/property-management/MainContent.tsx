        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
              <p>
                Owning a lucrative rental property requires significant time, expertise, and know-how. Let Rexgate alleviate the burden and hassle associated with property management.
              </p>
