...
const testimonials = [
  {
    ...
    review: "I was having a hard time finding reliable tenants for my rental property. Rexgate stepped in and took over the tenant screening process. Within just...",
  ...
  },
  {
    ...
    review: "Being an overseas property owner, managing maintenance issues was quite challenging. Rexgate' team managed everything, from",
    avatar: "/placeholder-user.jpg"
  },
  {
    name: "John D.",
    ...
    review: "I had a difficult situation with a tenant that needed to be evicted. Rexgate' team expertly navigated the legal process and",
    avatar: "/placeholder-user.jpg"
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 text-center mb-12 font-serif">
            FAQs About Rexgate Property Management Service Dubai
          </h2>
