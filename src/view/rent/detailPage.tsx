              ...
              <>
                ...
                <div className="flex items-center gap-4 bg-gradient-to-r from-[#F8F6F0] to-[#F2EEE8] px-4 py-3 rounded-xl border border-[#E5E1D8] shadow-lg">
                  <div className="relative">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-3 border-[#000000] shadow-md">
                  ...
                  <div className="flex gap-2">
                    ...
                    <a
                      ...
                      className="w-10 h-10 bg-[#000000] hover:bg-[#171717] rounded-full flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                    >
