        ...
        <div className="flex items-center gap-3 p-4 backdrop-blur-md">
          <div className="flex-1">
            <Input
              ...
              className="w-full text-gray-800 bg-white/90 border border-[#000000]/30 placeholder:text-gray-600 hover:border-[#000000]/50 transition-colors font-sans h-12"
            />
          </div>
          <Button
    ...
    <div>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gradient-to-br from-[#000000]/20 via-[#171717]/10 to-[#991B1B]/20"></div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto mb-12">
            <h1 className="text-3xl md:text-4xl font-light text-gray-800 mb-6 leading-tight font-serif">
              Discover Your Dream <span className="text-[#000000] font-normal">Luxury Property</span> in Dubai
            </h1>
        ...
        <div className="container mx-auto">
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-8 gap-3 sm:gap-4 p-4 sm:p-6 bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/20 shadow-xl">
            ...
            <div>
              ...
              >
                <SelectTrigger className="w-full bg-white/90 border border-[#000000]/30 text-gray-800 h-12 sm:h-14 hover:border-[#000000]/50 transition-colors font-sans">
            ...
            <div className="flex gap-2">
              <Button
                onClick={toggleFilters}
                variant="outline"
                className="w-28 sm:w-32 h-12 sm:h-14 bg-white/90 hover:bg-white border border-[#000000]/30 text-gray-700 hover:border-[#000000]/50 transition-colors flex items-center justify-center gap-2 font-sans text-xs sm:text-sm"
              >
