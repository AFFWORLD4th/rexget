...
export const metadata: Metadata = {
  title: 'Privacy Policy - REXGATE',
  description: 'Privacy Policy for REXGATE - Learn how we collect, use, and protect your personal information.',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                REXGATE ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="https://rexgate.ae" className="text-blue-600 hover:underline">rexgate.ae</a> or use our services.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To exercise these rights, please contact us at <a href="mailto:privacy@rexgate.ae" className="text-blue-600 hover:underline">privacy@rexgate.ae</a>.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 mb-2">Email: <a href="mailto:privacy@rexgate.ae" className="text-blue-600 hover:underline">privacy@rexgate.ae</a></p>
