...
function OffPlansPage() {
  ...
  return (
    <div>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto mb-12">
            <h1 className="text-3xl md:text-4xl font-light text-gray-800 mb-6 leading-tight font-serif">
              Exclusive <span className="text-[#000000] font-normal">Off-Plan Projects</span> in Dubai
            </h1>
            <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed font-sans max-w-3xl mx-auto">
              Be among the first to own in Dubai's most prestigious new developments. Discover off-plan properties 
              with exceptional investment potential and modern luxury amenities.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Search Section */}
      <section className="pt-32 pb-16 px-6 luxury-bg -mt-20 relative z-20">
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-8 gap-4 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl">
            ...
            <div className="col-span-2">
              <Input
                ...
                value={filters.title}
                onChange={(e) => handleFilterChange("title", e.target.value)}
                className="w-full text-gray-800 bg-white/90 border border-[#000000]/30 placeholder:text-gray-600 hover:border-[#000000]/50 transition-colors font-sans"
              />
            </div>
            ...
            <div>
              ...
              >
                <SelectTrigger className="w-full bg-white/90 border border-[#000000]/30 text-gray-800 hover:border-[#000000]/50 transition-colors font-sans">
