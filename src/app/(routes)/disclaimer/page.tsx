...
export const metadata: Metadata = {
  title: 'Disclaimer - REXGATE',
  description: 'Disclaimer for REXGATE - Important information about our services and limitations.',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The information contained on this website (rexgate.ae) is for general information purposes only. While we endeavor to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Any content submitted by users, including reviews, comments, or other materials, represents the views of the individual user and not necessarily the views of REXGATE. We are not responsible for the accuracy or reliability of user-generated content.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                In no event shall REXGATE, its officers, directors, employees, agents, or affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless REXGATE, its officers, directors, employees, agents, and affiliates from any claims, damages, losses, or expenses (including reasonable attorney's fees) arising from:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                REXGATE shall not be liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
