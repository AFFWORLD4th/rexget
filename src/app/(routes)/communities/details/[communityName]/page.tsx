          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div className="mt-16 pt-12 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-3">
                  {article.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-[#000000]/20 text-gray-700 rounded-full text-sm font-medium hover:bg-[#000000]/30 transition-colors font-sans"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="flex justify-center">
                <button className="bg-[#000000] text-white px-8 py-3 rounded-none font-medium hover:bg-[#171717] transition-colors">
                  View Properties
                </button>
              </div>
            </div>
