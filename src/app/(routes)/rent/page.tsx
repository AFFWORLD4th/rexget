        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto mb-12">
            <h1 className="text-3xl md:text-4xl font-light text-gray-800 mb-6 leading-tight font-serif">
              Find Your Perfect <span className="text-[#000000] font-normal">Luxury Rental</span> in Dubai
            </h1>
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-8 gap-4 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl">
            ...
            <div>
              <Select value={filters.listing_type} onValueChange={(value) => handleFilterChange("listing_type", value)}>
                <SelectTrigger className="w-full bg-white/90 border border-[#000000]/30 text-gray-800 h-14 hover:border-[#000000]/50 transition-colors font-sans">
            ...
            <div className="col-span-2">
              <Input
                ...
                value={filters.title}
                onChange={(e) => handleFilterChange("title", e.target.value)}
                className="w-full text-gray-800 bg-white/90 border border-[#000000]/30 placeholder:text-gray-600 hover:border-[#000000]/50 transition-colors font-sans h-14"
              />
            </div>
