...
export const metadata: Metadata = {
  title: 'Terms and Conditions - REXGATE',
  description: 'Terms and Conditions for REXGATE - Read our terms of service and user agreement.',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Welcome to REXGATE. These Terms and Conditions ("Terms") govern your use of our website <a href="https://rexgate.ae" className="text-blue-600 hover:underline">rexgate.ae</a> and our services. By accessing or using our website, you agree to be bound by these Terms.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">2. About REXGATE</h2>
              <p className="text-gray-700 mb-4">
                REXGATE is a real estate platform based in Dubai, UAE, providing property listings, real estate services, and related services. We are committed to connecting property buyers, sellers, and renters in the Dubai real estate market.
              </p>
              <div className="bg-gray-50 p-6 rounded-lg mb-4">
                <p className="text-gray-700 mb-2"><strong>Company Information:</strong></p>
                <p className="text-gray-700 mb-2">REXGATE</p>
                ...
                <p className="text-gray-700">Email: <a href="mailto:info@rexgate.ae" className="text-blue-600 hover:underline">info@rexgate.ae</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">3. Services Provided</h2>
              <p className="text-gray-700 mb-4">REXGATE provides the following services:</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The website and its content, including but not limited to text, graphics, logos, images, and software, are the property of REXGATE or its licensors and are protected by copyright, trademark, and other intellectual property laws.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To the maximum extent permitted by law, REXGATE shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of the website or services.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless REXGATE, its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the website or violation of these Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 mb-2"><strong>REXGATE</strong></p>
                <a
                ...
                <p className="text-gray-700 mb-2">Phone: <a href="tel:+971542524242" className="text-blue-600 hover:underline">+971 54 252 4242</a></p>
                <p className="text-gray-700 mb-2">Email: <a href="mailto:legal@rexgate.ae" className="text-blue-600 hover:underline">legal@rexgate.ae</a></p>
                <p className="text-gray-700">General Email: <a href="mailto:info@rexgate.ae" className="text-blue-600 hover:underline">info@rexgate.ae</a></p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                These Terms, together with our Privacy Policy and any other legal notices published on our website, constitute the entire agreement between you and REXGATE regarding your use of our website and services.
              </p>
            </section>
          </div>
        </div>
