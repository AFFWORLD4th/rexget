    ...
    >
      <div className="relative w-full h-80">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          <span className="bg-[#000000] text-white px-3 py-1 rounded-none text-xs font-light tracking-wider uppercase">
            FOR SALE
          </span>
    ...
    >
      ...
      <div className="px-4 py-6 text-left">
        ...
        <motion.a
          href={href}
          whileHover={{ x: 5 }}
          className="inline-flex items-center font-extralight tracking-wider hover:underline text-[#000000] uppercase"
          aria-label={`Read full article: ${title}`}
        >
          <span>Continue reading: {title.length > 50 ? `${title.substring(0, 50)}...` : title}</span>
